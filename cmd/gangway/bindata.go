...
func templatesHomeTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/home.tmpl", size: 2088, mode: os.FileMode(420), modTime: time.Unix(1528905241, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
