...
func templatesCommandlineTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/commandline.tmpl", size: 2804, mode: os.FileMode(420), modTime: time.Unix(1522262814, 0)}
...
func templatesHomeTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/home.tmpl", size: 2088, mode: os.FileMode(420), modTime: time.Unix(1522262814, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
